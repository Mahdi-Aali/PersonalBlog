...
public class UserAccountStatus : Enumeration
{
    ...
    public static UserAccountStatus Disabled => new(2, nameof(Disabled));
    ...
    public static IReadOnlyCollection<UserAccountStatus> AccountStatuses => [NotActive, Active, Disabled, Banned, Suspend, EmailSuspend, PhoneNumberSuspend];
